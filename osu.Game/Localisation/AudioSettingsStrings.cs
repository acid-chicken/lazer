...
namespace osu.Game.Localisation
{
    public static class AudioSettingsStrings
    {
        ...
        /// "Never"
        /// </summary>
        public static LocalisableString ExclusiveModeBehaviourNever => new TranslatableString(getKey("exclusive_mode_behaviour_never"), @"Never");

        /// <summary>
        /// "Always"
        /// </summary>
        public static LocalisableString ExclusiveModeBehaviourAlways => new TranslatableString(getKey("exclusive_mode_behaviour_always"), @"Always");

        /// <summary>
        /// "During active"
        /// </summary>
        public static LocalisableString ExclusiveModeBehaviourDuringActive => new TranslatableString(getKey("exclusive_mode_behaviour_during_active"), @"During active");

        /// <summary>
        /// "During gameplay"
        /// </summary>
        public static LocalisableString ExclusiveModeBehaviourDuringGameplay => new TranslatableString(getKey("exclusive_mode_behaviour_during_gameplay"), @"During gameplay");
