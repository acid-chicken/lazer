...
namespace osu.Game.Overlays.Settings.Sections.Audio
{
    public partial class AudioDevicesSettings : SettingsSubsection
    {
        ...
        private SettingsDropdown<ExclusiveModeBehaviour> exclusiveModeBehaviour;

        private bool automaticBackendInUse;

        [BackgroundDependencyLoader]
        private void load(FrameworkConfigManager config, OsuConfigManager localConfig, OsuGame game, IDialogOverlay dialogOverlay)
        {
            var currentBackend = config.GetBindable<AudioBackend>(FrameworkSetting.AudioBackend);
            var currentExclusiveModeBehaviour = localConfig.GetBindable<ExclusiveModeBehaviour>(OsuSetting.ExclusiveModeBehaviour);
            ...
            Children = new Drawable[]
            {
                ...
                exclusiveModeBehaviour = new SettingsEnumDropdown<ExclusiveModeBehaviour>
                {
